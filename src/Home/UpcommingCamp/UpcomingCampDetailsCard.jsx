...
import UpcomingCampRegistrationModal from './UpcomingCampRegistrationModal';
import useProfessional from '../../hooks/useProfessional';
import Loading from '../../Components/Loading'
import UpcomingCampProfessionalModal from './UpcomingCampProfessionalModal';
...
const UpcomingCampDetailsCard = ({ camp }) => {
    const { user } = useAuth()
        ...
        <div className=''>
            <Card sx={{ maxWidth: 600 }}>
                ...
                <CardActions disableSpacing>
                    ...
                    {isProfessional ?
                        <Button onClick={handleOpen2} className='joinbtn'>Interested Upcoming</Button>
                        :
                        <Button disabled={isOrganizer} onClick={handleOpen} className='joinbtn'>Join upcoming Camp</Button>
                    }
                    <ExpandMore
                        expand={expanded}
            ...
            <UpcomingCampRegistrationModal camp={camp} handleOpen={handleOpen} handleClose={handleClose} id={_id} open={open}></UpcomingCampRegistrationModal>
            <UpcomingCampProfessionalModal camp={camp} handleOpen={handleOpen2} handleClose={handleClose2} id={_id} open={open2}></UpcomingCampProfessionalModal>
        </div>
    );
};

export default UpcomingCampDetailsCard;